				...
				<div style="height: 140px; width: 100%;">				
					<div class="reldiv">	
						...
						<div style="position: absolute; margin: 116px 0 0 210px;">
							...
							<a class="smFrame staticTip" href="http://www.landoflegends.de/index.php" onmouseover="setTipText('{$loc/strs/unsorted/str[@id='armory.forum.link.realm']}');">
							...
							<a class="smFrame staticTip" href="http://www.landoflegends.de/portal.php" onmouseover="setTipText('{$loc/strs/unsorted/str[@id='armory.forum.link.battleGroup']}');">
								<xsl:if test="not($region = 'US' or $region = 'EU')">
									<xsl:attribute name="href">javascript:void(0)</xsl:attribute>
									<xsl:attribute name="class">smFrame</xsl:attribute>
									<xsl:attribute name="onmouseover"></xsl:attribute>						
